...
def run_beam_search(sess, model, vocab, batch, hps):
    
    enc_states, dec_in_state = model.runEncoder(sess, batch)
    ...
    steps = 0
    while steps < hps.beam_dec_steps and len(results) < hps.beam_size:
